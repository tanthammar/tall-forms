...
<div wire:ignore class="w-full p-6 mx-auto bg-white border-2 border-gray-300 border-dashed rounded-lg relative hover:shadow-outline-gray">
        {{-- init Alpine --}}
        <div x-data="imageData{{$field->name}}()" x-init="initCroppie()" class="active:shadow-sm active:border-blue-500">
            ...
            {{-- result--}}
            <div x-show="!showCroppie && hasImage" class="relative {{ $field->resultContainer }}">
