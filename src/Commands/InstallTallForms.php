...
//        $this->info(exec('npm install tailwindcss@npm:@tailwindcss/postcss7-compat postcss-import autoprefixer@9 alpinejs @tailwindcss/forms @tailwindcss/typography @tailwindcss/aspect-ratio --save-dev'));
        $this->info(exec('npm install @tailwindcss/forms @tailwindcss/typography @tailwindcss/aspect-ratio --save-dev'));
